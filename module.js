...
speech.addCommands({
  "Wer bist du (eigentlich)": () => {
    responsiveVoice.speak("Ich bin hier der Spiegel.", "Deutsch Female")
    renderer.showVoiceOverlay(false)
  },
  "Wie sehe ich aus": () => {
    responsiveVoice.speak("Gar nicht übel, aber die Haare könnten besser sitzen.", "Deutsch Female")
    renderer.showVoiceOverlay(false)
  },
  "Was kostest du": () => {
    responsiveVoice.speak("So etwa 280 Euro denke ich.", "Deutsch Female")
    renderer.showVoiceOverlay(false)
  },
  "Wie funktionierst du": () => {
    responsiveVoice.speak(`
      ...
      Hey Spiegel oder Hey Mirror sagst. Diese werden zur Verarbeitung an Google geschickt
      und ich bekomme den Text wieder. Daraus lese ich dann ab, was du wohl vorhast.
      Jede meiner Funktionen kommt aus einem Modul, da gibt es welche für Wetter, Nahrichten,
